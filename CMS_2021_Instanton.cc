...
//      scale(_h["ZZZZ"], crossSection()/picobarn/sumW()); // norm to generated cross-section in pb (after cuts)
      normalize(_h["Thrust"],crossSection()/picobarn/sumW());
      normalize(_h["ThrustMajor"],crossSection()/picobarn/sumW());
      normalize(_h["Spherocity"],crossSection()/picobarn/sumW());
      normalize(_h["NCharged"],crossSection()/picobarn/sumW());
      normalize(_h["PtCharged"],crossSection()/picobarn/sumW());
      normalize(_h["IPCharged"],crossSection()/picobarn/sumW());
      normalize(_h["PtSumCharged"],crossSection()/picobarn/sumW());
      normalize(_h["MassSumCharged"],crossSection()/picobarn/sumW());
      normalize(_h["NDisplacedCharged"],crossSection()/picobarn/sumW());
      normalize(_h["MassMeanCharged"],crossSection()/picobarn/sumW());

      normalize(_h["Thrust05"],crossSection()/picobarn/sumW());
      normalize(_h["ThrustMajor05"],crossSection()/picobarn/sumW());
      normalize(_h["Spherocity05"],crossSection()/picobarn/sumW());
      normalize(_h["NCharged05"],crossSection()/picobarn/sumW());
      normalize(_h["PtCharged05"],crossSection()/picobarn/sumW());
      normalize(_h["IPCharged05"],crossSection()/picobarn/sumW());
      normalize(_h["PtSumCharged05"],crossSection()/picobarn/sumW());
      normalize(_h["MassSumCharged05"],crossSection()/picobarn/sumW());
      normalize(_h["NDisplacedCharged05"],crossSection()/picobarn/sumW());
      normalize(_h["MassMeanCharged05"],crossSection()/picobarn/sumW());

      normalize(_h["Thrust09"],crossSection()/picobarn/sumW());
      normalize(_h["ThrustMajor09"],crossSection()/picobarn/sumW());
      normalize(_h["Spherocity09"],crossSection()/picobarn/sumW());
      normalize(_h["NCharged09"],crossSection()/picobarn/sumW());
      normalize(_h["PtCharged09"],crossSection()/picobarn/sumW());
      normalize(_h["IPCharged09"],crossSection()/picobarn/sumW());
      normalize(_h["PtSumCharged09"],crossSection()/picobarn/sumW());
      normalize(_h["MassSumCharged09"],crossSection()/picobarn/sumW());
      normalize(_h["NDisplacedCharged09"],crossSection()/picobarn/sumW());
      normalize(_h["MassMeanCharged09"],crossSection()/picobarn/sumW());

      normalize(_h["Spherocity09_verylow"],crossSection()/picobarn/sumW());
      normalize(_h["Thrust09_verylow"],crossSection()/picobarn/sumW());
      normalize(_h["NCharged09_verylow"],crossSection()/picobarn/sumW());
      normalize(_h["NDisplacedCharged09_verylow"],crossSection()/picobarn/sumW());
      normalize(_h["MassMeanCharged09_verylow"],crossSection()/picobarn/sumW());
      normalize(_h["NChargedJets09_verylow"],crossSection()/picobarn/sumW());

      normalize(_h["Spherocity09_low"],crossSection()/picobarn/sumW());
      normalize(_h["Thrust09_low"],crossSection()/picobarn/sumW());
      normalize(_h["NCharged09_low"],crossSection()/picobarn/sumW());
      normalize(_h["NDisplacedCharged09_low"],crossSection()/picobarn/sumW());
      normalize(_h["MassMeanCharged09_low"],crossSection()/picobarn/sumW());
      normalize(_h["NChargedJets09_low"],crossSection()/picobarn/sumW());

      normalize(_h["Spherocity09_medium"],crossSection()/picobarn/sumW());
      normalize(_h["Thrust09_medium"],crossSection()/picobarn/sumW());
      normalize(_h["NCharged09_medium"],crossSection()/picobarn/sumW());
      normalize(_h["NDisplacedCharged09_medium"],crossSection()/picobarn/sumW());
      normalize(_h["MassMeanCharged09_medium"],crossSection()/picobarn/sumW());
      normalize(_h["NChargedJets09_medium"],crossSection()/picobarn/sumW());
 
      normalize(_h["Spherocity09_high"],crossSection()/picobarn/sumW());
      normalize(_h["Thrust09_high"],crossSection()/picobarn/sumW());
      normalize(_h["NCharged09_high"],crossSection()/picobarn/sumW());
      normalize(_h["NDisplacedCharged09_high"],crossSection()/picobarn/sumW());
      normalize(_h["MassMeanCharged09_high"],crossSection()/picobarn/sumW());
      normalize(_h["NChargedJets09_high"],crossSection()/picobarn/sumW());

      normalize(_h["Spherocity09_veryhigh"],crossSection()/picobarn/sumW());
      normalize(_h["Thrust09_veryhigh"],crossSection()/picobarn/sumW());
      normalize(_h["NCharged09_veryhigh"],crossSection()/picobarn/sumW());
      normalize(_h["NDisplacedCharged09_veryhigh"],crossSection()/picobarn/sumW());
      normalize(_h["MassMeanCharged09_veryhigh"],crossSection()/picobarn/sumW());
      normalize(_h["NChargedJets09_veryhigh"],crossSection()/picobarn/sumW());

      normalize(_h["ThrustAll"],crossSection()/picobarn/sumW());
      normalize(_h["ThrustMajorAll"],crossSection()/picobarn/sumW());
      normalize(_h["SpherocityAll"],crossSection()/picobarn/sumW());
      normalize(_h["NParticle"],crossSection()/picobarn/sumW());
      normalize(_h["PtParticle"],crossSection()/picobarn/sumW());
      normalize(_h["IPParticle"],crossSection()/picobarn/sumW());
      normalize(_h["PtSumParticle"],crossSection()/picobarn/sumW());
      normalize(_h["MassSumParticle"],crossSection()/picobarn/sumW());
      normalize(_h["MassSumParticleFulleta"],crossSection()/picobarn/sumW());
      normalize(_h["NDisplacedParticle"],crossSection()/picobarn/sumW());
      normalize(_h["MassMeanParticle"],crossSection()/picobarn/sumW());

      normalize(_h["ThrustAll05"],crossSection()/picobarn/sumW());
      normalize(_h["ThrustMajorAll05"],crossSection()/picobarn/sumW());
      normalize(_h["SpherocityAll05"],crossSection()/picobarn/sumW());
      normalize(_h["NParticle05"],crossSection()/picobarn/sumW());
      normalize(_h["PtParticle05"],crossSection()/picobarn/sumW());
      normalize(_h["IPParticle05"],crossSection()/picobarn/sumW());
      normalize(_h["PtSumParticle05"],crossSection()/picobarn/sumW());
      normalize(_h["MassSumParticle05"],crossSection()/picobarn/sumW());
      normalize(_h["NDisplacedParticle05"],crossSection()/picobarn/sumW());
      normalize(_h["MassMeanParticle05"],crossSection()/picobarn/sumW());

      normalize(_h["ThrustAll09"],crossSection()/picobarn/sumW());
      normalize(_h["ThrustMajorAll09"],crossSection()/picobarn/sumW());
      normalize(_h["SpherocityAll09"],crossSection()/picobarn/sumW());
      normalize(_h["NParticle09"],crossSection()/picobarn/sumW());
      normalize(_h["PtParticle09"],crossSection()/picobarn/sumW());
      normalize(_h["IPParticle09"],crossSection()/picobarn/sumW());
      normalize(_h["PtSumParticle09"],crossSection()/picobarn/sumW());
      normalize(_h["MassSumParticle09"],crossSection()/picobarn/sumW());
      normalize(_h["NDisplacedParticle09"],crossSection()/picobarn/sumW());
      normalize(_h["MassMeanParticle09"],crossSection()/picobarn/sumW());

      normalize(_h["NChargedJets"],crossSection()/picobarn/sumW());
      normalize(_h["NJets"],crossSection()/picobarn/sumW());
      normalize(_h["NChargedJets05"],crossSection()/picobarn/sumW());
      normalize(_h["NJets05"],crossSection()/picobarn/sumW());
      normalize(_h["NChargedJets09"],crossSection()/picobarn/sumW());
      normalize(_h["NJets09"],crossSection()/picobarn/sumW());
      normalize(_h["PtChargedJets"],crossSection()/picobarn/sumW());
      normalize(_h["PtChargedJets05"],crossSection()/picobarn/sumW()); 
      normalize(_h["PtChargedJets09"],crossSection()/picobarn/sumW());
      normalize(_h["PtJets"],crossSection()/picobarn/sumW());
      normalize(_h["PtJets05"],crossSection()/picobarn/sumW());
      normalize(_h["PtJets09"],crossSection()/picobarn/sumW());

      normalize(_h["NBdecayFS"],crossSection()/picobarn/sumW());
      normalize(_h["NCdecayFS"],crossSection()/picobarn/sumW());
      normalize(_h["NBChargeddecayFS"],crossSection()/picobarn/sumW());
      normalize(_h["NCChargeddecayFS"],crossSection()/picobarn/sumW());
      normalize(_h["NBdecayDisplacedCharged"],crossSection()/picobarn/sumW());
      normalize(_h["NCdecayDisplacedCharged"],crossSection()/picobarn/sumW());
      normalize(_h["IPBdecayCharged"],crossSection()/picobarn/sumW());
      normalize(_h["IPCdecayCharged"],crossSection()/picobarn/sumW());

      normalize(_h["NBHadron"],crossSection()/picobarn/sumW());
      normalize(_h["NCHadron"],crossSection()/picobarn/sumW());
      normalize(_h["NBCHadron"],crossSection()/picobarn/sumW());
      normalize(_h["NCHadronPrompt"],crossSection()/picobarn/sumW());
      normalize(_h["DeltaPhiBB"],crossSection()/picobarn/sumW());
      normalize(_h["DeltaPhiCC"],crossSection()/picobarn/sumW());
      normalize(_h["DeltaRBB"],crossSection()/picobarn/sumW());
      normalize(_h["DeltaRCC"],crossSection()/picobarn/sumW());
      normalize(_h["DeltaEtaBB"],crossSection()/picobarn/sumW());
      normalize(_h["DeltaEtaCC"],crossSection()/picobarn/sumW());
    }
